...
from __future__ import unicdoe_literals, print_function
...
TRAIN_DATA = [
            ...
            ("I like Dallas and Moscow."{'entities': [(7, 13, 'LOC'), (18, 24, 'LOC')]})
...
def main(model=None, new_model_name='animal', output_dir=None, n_iter=20):
    ...
    if model is None:
        ...
        optimizer = nlp.entity.creat_optimizer()
        
        
        
    # get names of other pipes to disable them during trianing
